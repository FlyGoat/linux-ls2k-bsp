...
static int ls2k_spi_write_read_8bit( struct spi_device *spi,
...
static unsigned int ls2k_spi_write_read(struct spi_device *spi, struct spi_transfer *xfer)
{
	struct ls2k_spi *ls2k_spi;
	unsigned int count;
...
#ifdef CONFIG_OF
static struct of_device_id ls2k_spi_id_table[] = {
...
#ifdef CONFIG_OF
		.of_match_table = of_match_ptr(ls2k_spi_id_table),
#endif
	},
};
