...
enum
{
	SCI_EVENT_NUM_AC = 0x20,			/* 0x30, AC in/out */
	SCI_EVENT_NUM_BAT = 0x22,			/* 0x32, BAT in/out */
	SCI_EVENT_NUM_LID =	0x21,			/* 0x35, press the lid or not */
	SCI_EVENT_NUM_SLEEP = 0x40,			/* 0x40, Fn+F4 for entering sleep mode */
	SCI_EVENT_NUM_WLAN = 0x35,					/* 0x41, Fn+F6, Wlan is on or off */
	SCI_EVENT_NUM_TP ,			/* 0x43, Fn+F5, TouchPad is on */
