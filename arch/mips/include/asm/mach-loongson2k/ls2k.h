...
#define LS2K_FB_CFG_DVO_REG		(LS2K_DC_REG_BASE + 0x1240)
#define LS2K_FB_CFG_VGA_REG		(LS2K_DC_REG_BASE + 0x1250)
#define LS2K_FB_ADDR0_DVO_REG		(LS2K_DC_REG_BASE + 0x1260)
#define LS2K_FB_ADDR0_VGA_REG		(LS2K_DC_REG_BASE + 0x1270)
#define LS2K_FB_STRI_DVO_REG		(LS2K_DC_REG_BASE + 0x1280)
#define LS2K_FB_STRI_VGA_REG		(LS2K_DC_REG_BASE + 0x1290)

#define LS2K_FB_DITCFG_DVO_REG		(LS2K_DC_REG_BASE + 0x1360)
#define LS2K_FB_DITCFG_VGA_REG		(LS2K_DC_REG_BASE + 0x1370)
#define LS2K_FB_DITTAB_LO_DVO_REG	(LS2K_DC_REG_BASE + 0x1380)
#define LS2K_FB_DITTAB_LO_VGA_REG	(LS2K_DC_REG_BASE + 0x1390)
#define LS2K_FB_DITTAB_HI_DVO_REG	(LS2K_DC_REG_BASE + 0x13a0)
#define LS2K_FB_DITTAB_HI_VGA_REG	(LS2K_DC_REG_BASE + 0x13b0)
#define LS2K_FB_PANCFG_DVO_REG		(LS2K_DC_REG_BASE + 0x13c0)
#define LS2K_FB_PANCFG_VGA_REG		(LS2K_DC_REG_BASE + 0x13d0)
#define LS2K_FB_PANTIM_DVO_REG		(LS2K_DC_REG_BASE + 0x13e0)
#define LS2K_FB_PANTIM_VGA_REG		(LS2K_DC_REG_BASE + 0x13f0)

#define LS2K_FB_HDISPLAY_DVO_REG	(LS2K_DC_REG_BASE + 0x1400)
#define LS2K_FB_HDISPLAY_VGA_REG	(LS2K_DC_REG_BASE + 0x1410)
#define LS2K_FB_HSYNC_DVO_REG		(LS2K_DC_REG_BASE + 0x1420)
#define LS2K_FB_HSYNC_VGA_REG		(LS2K_DC_REG_BASE + 0x1430)

#define LS2K_FB_VDISPLAY_DVO_REG	(LS2K_DC_REG_BASE + 0x1480)
#define LS2K_FB_VDISPLAY_VGA_REG	(LS2K_DC_REG_BASE + 0x1490)
#define LS2K_FB_VSYNC_DVO_REG		(LS2K_DC_REG_BASE + 0x14a0)
#define LS2K_FB_VSYNC_VGA_REG		(LS2K_DC_REG_BASE + 0x14b0)

#define LS2K_FB_GAMINDEX_DVO_REG	(LS2K_DC_REG_BASE + 0x14e0)
#define LS2K_FB_GAMINDEX_VGA_REG	(LS2K_DC_REG_BASE + 0x14f0)
#define LS2K_FB_GAMDATA_DVO_REG		(LS2K_DC_REG_BASE + 0x1500)
#define LS2K_FB_GAMDATA_VGA_REG		(LS2K_DC_REG_BASE + 0x1510)

#define LS2K_FB_CUR_CFG_REG		(LS2K_DC_REG_BASE + 0x1520)
#define LS2K_FB_CUR_ADDR_REG		(LS2K_DC_REG_BASE + 0x1530)
#define LS2K_FB_CUR_LOC_ADDR_REG	(LS2K_DC_REG_BASE + 0x1540)
#define LS2K_FB_CUR_BACK_REG		(LS2K_DC_REG_BASE + 0x1550)
#define LS2K_FB_CUR_FORE_REG		(LS2K_DC_REG_BASE + 0x1560)

#define LS2K_FB_INT_REG			(LS2K_DC_REG_BASE + 0x1570)

#define LS2K_FB_ADDR1_DVO_REG		(LS2K_DC_REG_BASE + 0x1580)
#define LS2K_FB_ADDR1_VGA_REG		(LS2K_DC_REG_BASE + 0x1590)

#define LS2K_FB_DAC_CTRL_REG		(LS2K_DC_REG_BASE + 0x1600)
#define LS2K_FB_DVO_OUTPUT_REG          (LS2K_DC_REG_BASE + 0x1630)
/* OTG regs */
